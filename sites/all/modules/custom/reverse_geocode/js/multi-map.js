...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        function mapmyindia_number_on_marker($ss) {
            ...
            var icon = L.divIcon({className: 'my-div-icon', html: "<img style='position:relative;width:35px;height:35px' src=" + icon_path + '><span style="position: absolute;left:1.2em;right: 1em;top:0.4em;bottom:3em; font-size:12px;font-weight:bold;width: 1px; color:black;" class="my-div-span">' + (sr) + '</span>', iconSize: [10, 10], popupAnchor: [12, -10]});/*function that creates a div over a icon and display content on the div*/
