...
(function ($) {
	...
	Drupal.behaviors.leanbox_dashboard_unloading_ota = {
		attach: function (context, settings) {

			var area_definition = Drupal.settings.leanbox_dashboard.area_definition;
			var party_pack_data = Drupal.settings.leanbox_dashboard.unloading_ota;
			...
			$(".unloading-ota-submit").click(function (e) {
				...
				if (start_date != '' && end_date != '') {
					$.ajax({
						...
						data: {start_date: start_date, end_date: end_date, activity_type: 'unloading_ota'},
