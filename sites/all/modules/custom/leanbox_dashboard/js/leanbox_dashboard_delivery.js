...
(function ($) {
	...
	Drupal.behaviors.leanbox_dashboard_delivery = {
		attach: function (context, settings) {

			var delivery_data = Drupal.settings.leanbox_dashboard.delivery;
			  ...
			  var start_date = $(this).parent().prev().prev().find("input[name='start_date[date]']").val();
				...
				if (start_date != '' && end_date != '') {
					$.ajax({
						...
						data: {start_date: start_date, end_date: end_date, activity_type: 'delivery'},
			...
			function drawpickingChart(delivery_data, area_definition) {
				...
				var chart = new google.visualization.ColumnChart(document.getElementById('delivery_div'));
